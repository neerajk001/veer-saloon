          ...
          <section className="mb-12">
            ...
            {selectedServices.length === 0 ? (
              ...
              <div className="bg-white">
                ...
                <div className="mt-4 flex items-center justify-center gap-2 text-[11px] text-gray-500 bg-gray-50 border border-gray-100 rounded-lg p-2">
                  <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="font-semibold">If a time slot is not shown, it is already booked, blocked, or in the past.</span>
                </div>
              </div>
            )}
          </section>
            ...
            <section className="mb-8 animate-in fade-in slide-in-from-bottom-4">
              <div className="bg-gray-50 p-6 rounded-none border-l-4 border-black">
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-orange-50 border border-orange-100 rounded-xl p-3 mt-4 text-xs text-orange-800 flex gap-2 items-start">
